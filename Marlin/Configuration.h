...
#define TEMP_SENSOR_BED 1 // Anet uses NTC 100 K 1% 3950 - 11 ?
...
//  #define DEFAULT_bedKd 305.4
  ...
  // #define DEFAULT_bedKp 324.56
  // #define DEFAULT_bedKi 72.75
  // #define DEFAULT_bedKd 361.96

  #define DEFAULT_bedKp 465.77
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 94.86 } // 140.86 // { 40, 40, 200, 70.43 } //{ 160, 160, 800, 281.72 } // 140.86 //{ 100, 100, 400, 95 } //{ 200, 200, 800, 190 } //{ 100, 100, 400, 100 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.042 // (mm) Distance from real junction edge
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 22, -8, -3.7 } // { -5, 57, -7 } //{ 25, -8, -5 }
...
//#define Z_PROBE_END_SCRIPT "G4 P1000\nM340 P0 S0"
//#define Z_PROBE_END_SCRIPT "G1 X50 Y50 F6000"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 20 //((X_BED_SIZE) / 2)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 67 //((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
#endif
